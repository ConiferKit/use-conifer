 ...
 *
 * This reads `typhoon/`, the repo that is actually DEPLOYED. The first draft
 * read `typhoon-gateway/`, an older sibling checkout whose artifact was two
...
const gatewayContract = JSON.parse(
  readFileSync(here("../../typhoon/contracts/gateway-contract.json"), "utf8"),
